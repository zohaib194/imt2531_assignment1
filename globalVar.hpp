...
// Texture info
const glm::vec2 textureSize = glm::vec2(0.13f, 0.199f);		// Size of each figure in the texture
const glm::vec2 textureMargin = glm::vec2(0.015f, 0.023f);	// Margin around each figure.
